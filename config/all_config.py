...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        ''' we choose num_frames # F = [12, 15, 18, 21, 24] '''
        ...
        ''' we choose ViT-B/32 and ViT-B/16 of MSRVTT Dataset'''
        ...
        parser.add_argument('--save_memory_mode', action='store_true', default=False, help='if specified, will use sim_matrix_inference_light_allops() at eval no matter of the dataset')
