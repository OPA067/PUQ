...
if __name__ == '__main__':
    ...
    pie_net = PIENet(1, 512, 512, 512 // 2)
    out = torch.randn(8, 512)
    out_pool = torch.randn(8, 12, 512)

    out, attn, residual = pie_net(out, out_pool)
    print(out.shape, attn.shape, residual.shape)