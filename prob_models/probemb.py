...
class MCSoftContrastiveLoss(nn.Module):
    ...
    def forward_(self, image_features, caption_features, image_logsigma, caption_logsigma, **kwargs):
        ...
        i2t_loss = self._compute_loss(image_features, caption_features)
        t2i_loss = self._compute_loss(caption_features, image_features)
    ...
    def forward(self, sampled_video_features, video_logsigma, sampled_text_features, text_logsigma, **kwargs):
